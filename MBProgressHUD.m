...
#define COLOR_RED_FF5   ColorFromRGB(0x4FBCE8) //青蓝色  紅色 0xFF5A5F
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        self.activityIndicatorColor = COLOR_RED_FF5; //[UIColor grayColor];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		_progress = 0.f;
		_annular = NO;
        _progressTintColor = [UIColor clearColor]; //[[UIColor alloc] initWithWhite:1.f alpha:1.f];
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		_progress = 0.f;
        _lineColor = [UIColor clearColor];//[UIColor whiteColor];
        _progressColor = [UIColor clearColor];//[UIColor whiteColor];
